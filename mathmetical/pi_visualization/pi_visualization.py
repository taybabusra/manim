...
class PiCircle(MovingCameraScene):
    def construct(self):
        ...
        path = VGroup(stroke_width=2, stroke_opacity=0.05)  
        paths = VGroup()  
        ...
        frame.set(width=2 * pi_circle.get_width())
        ...
        self.play(frame.animate.set(width=2 * pi.get_width()), run_time=3)
        self.wait()